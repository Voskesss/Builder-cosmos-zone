...
const ToggleSwitch = ({ className = "" }: ToggleSwitchProps) => {
  return (
    <div
      className={`rounded-full border border-white/30 bg-white/20 backdrop-blur-sm p-3 shadow-md ${className}`}
    >
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          <div className="w-11 h-7 bg-[#004B60] rounded-full flex items-center justify-end pr-1">
